...
/***/ function(module, exports, __webpack_require__) {
	...
	if (global.TorflixChromeExtensionLoaded) {
	  ...
	  messageBus.onReceiveMessage = function(arg) {
	    ...
	    switch (type) {
	      case 'ping':
	        return messageBus.sendMessage('pong', payload);
	      case 'pong':
	        return console.log('TorflixChromeExtension received pong', payload);
	    }
	  };
	  console.log('TorflixChromeExtension loaded');
	  messageBus.sendMessage('ready').then(function(response) {
	    debugger;
